...
$(document).ready(function () {
  ...
  // When a search filter is changed, a call to the server is made with the values
  // embedded in the filter and in the topmost "about yourself" controls.
  $('#search-filters .filter').change(function () {
    window.location.href = controlsToQueryString(['#search-filters .filter', 'filter-item']);
  });
})
